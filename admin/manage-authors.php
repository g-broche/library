                        ...
                        <tbody>
                            <?php foreach ($tableAuthors[1] as $auteur) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <form action="edit-author.php" method="post"><button type="submit" name="edit" value=<?= $auteur['id'] ?>>Editer</button>
                                            </form>
                                            <form action="manage-authors.php" method="post"><button type="submit" name="delete" value=<?= $auteur['id'] ?>>Supprimer</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
