                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="reg-readers.php" method="post"><button type="submit" name="enable"
                                        value=<?=$user['id']?>>actif</button>
                                </form>
                                <form action="reg-readers.php" method="post"><button type="submit" name="delete"
                                        value=<?=$user['id']?>>Supprimer</button>
                                </form>
                                <?php elseif($user['Status']==1): ?>
                                <form action="reg-readers.php" method="post"><button type="submit" name="disable"
                                        value=<?=$user['id']?>>bloquer</button>
                                </form>
                                <form action="reg-readers.php" method="post"><button type="submit" name="delete"
                                        value=<?=$user['id']?>>Supprimer</button>
                                </form>
